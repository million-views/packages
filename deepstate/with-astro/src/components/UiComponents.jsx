...
const UIComponentExplorerCombined = () => {
  ...
  const filteredComponents = useMemo(() => {
    ...
    componentData.vendors.forEach((vendor) => {
      if (selectedFramework !== "all" && vendor.name !== selectedFramework) {
        return;
      }
  ...
  }, [componentData, selectedCategory, selectedFramework, searchTerm]);
                ...
                <div>
                  <div className="mb-4">
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      Framework: {selectedComponent.vendor}
                    </p>
                  </div>
                  ...
                  {selectedComponent.alsoKnownAs &&
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {selectedComponent.alsoKnownAs.map((aka) => (
                          <span
                            key={aka}
