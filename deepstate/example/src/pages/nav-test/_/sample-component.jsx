...
/**
 * Sample component to demonstrate in-page rendering via NavigatedContent
 * This component uses signals for reactivity
 */
export default function SampleComponent({ route }) {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-6 max-w-md mx-auto">
      ...
      <p className="mb-4">
        This component is rendered in-page through the NavigatedContent
        component. It doesn't require a full page navigation.
      </p>
      ...
      <div className="bg-blue-50 p-4 rounded-lg mb-6">
        <p className="text-sm text-blue-800">
          ...
          <span className="font-mono block mt-1">
            {route && route.path ? `Path: ${route.path}` : "No path"} |
            {route && route.label ? `Label: ${route.label}` : "No label"}
          </span>
        </p>
      </div>
