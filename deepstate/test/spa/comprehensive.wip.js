...
describe("DeepState v2 Core Functionality (SPA Mode)", () => {
  ...
  describe("Real-time Filtering Example", () => {
    function createFilterStore() {
      return reify({
        ...
        filteredItems: computedProp(function (self) {
        ...
        stats: computedProp(function (self) {
          return {
    ...
    it("handles nested computed properties", () => {
      const store = reify({
        user: {
          firstName: "John",
          lastName: "Doe",
          fullName: computedProp(function (self) {
  ...
  describe("Array Operations", () => {
    ...
    it("properly updates computed properties with array mutations", () => {
      const store = reify({
        items: [1, 2, 3],
        sum: computedProp(function (self) {
  ...
  describe("Edge Cases", () => {
    ...
    it("handles error in computed property", () => {
      ...
      const store = reify({
        willError: true,
        problematic: computedProp(function (self) {
          if (self.willError) {
      ...
      return reify({
        tasks: [
          ...
          },
          {
            ...
            isEnabled: computedProp(function (self, root) {
