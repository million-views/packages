...
const Navigator = () => {
  ...
  // Helper function to check if the current route matches the one with children
  // We need this to decide whether to show secondary/tertiary navigation
  const isExactRouteMatch = (item) => {
    ...
    // For 'end' match (no trailing segments)
    if (item.end && activePage === item.path) return true;
